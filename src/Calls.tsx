...
const Calls = ({navigation}:any)=> {
  ...
  return (
    ...
    <View  style={{ backgroundColor: '#FFFFFF' }}><View style={{ flexDirection: 'row', padding: 18, backgroundColor: '#FFFFFF' }}>
    ...
    /> */}
      ...
      <MaterialCommunityIcons name="link" size={50} color="white" style={{  backgroundColor: 'green' , borderRadius:50}}/>
              ...
              <View style={{ flexDirection: 'row', padding: 18, backgroundColor: '#FFFFFF' }}>
                ...
                <View style={{ marginLeft: 15 }}>
                  ...
                  <View style={{flexDirection:'row'}}>
                    ...
                    <Text>{item.time}</Text>
                    <FontAwesome name={item.symbol} size={25} color="green" style={{marginLeft: 200}} />
                  </View>
                </View>
              </View>
